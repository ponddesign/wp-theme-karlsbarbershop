...
<?php do_action( 'wp_theme_karlsbarbershop_esbuild_site_before' ); ?>

<div id="page" class="min-h-screen flex flex-col">

	<?php do_action( 'wp_theme_karlsbarbershop_esbuild_header' ); ?>
	...
	<div id="content" class="site-content flex-grow">
		...
		<?php do_action( 'wp_theme_karlsbarbershop_esbuild_content_start' ); ?>
